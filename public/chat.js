(function () {
  ...
  function applyLayout(instance) {
    ...
    if (instance.refs && instance.refs.messages) {
      instance.refs.messages.scrollTop = instance.refs.messages.scrollHeight;
    }
  }
